package com.fedex.invoice.config;
...
public class KafkaConfiguration extends KafkaConfigCommon {
	...
	@Value("${kafka_invoice_consumer_group}")
	protected String kafka_invoice_consumer_group;

	@Value("${kafka_client_concurrency_invoice}")
	protected int kafka_client_concurrency_invoice;
	...
	public ConcurrentKafkaListenerContainerFactory<String, String> kafkaListenerContainerFactory() {
		...
		factory.setConcurrency(kafka_client_concurrency_invoice);
		return factory;
	}
	...
	public ConsumerFactory<String, String> consumerFactory() {
		...
		config.put(ConsumerConfig.GROUP_ID_CONFIG, kafka_invoice_consumer_group);
